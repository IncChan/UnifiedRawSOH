...
export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e2_unified_multidomain/unified/public_xjtu_mit_domain_balanced.json"
...
for source_config in \
  ...
  "${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_mit.json"; do
