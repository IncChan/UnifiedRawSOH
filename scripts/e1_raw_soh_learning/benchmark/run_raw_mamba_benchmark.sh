...
case "${DOMAIN}" in
  xjtu)
    export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_xjtu.json"
    ;;
  mit)
    export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_mit.json"
    ;;
  smarthealth_lishen40)
    export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_smarthealth_lishen40.json"
    ;;
  smarthealth_catl280)
    export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_smarthealth_catl280.json"
    ;;
  smarthealth_eve280)
    export CONFIG_SOURCE="${PROJECT_ROOT}/UnifiedRawSOH/configs/e1_raw_soh_learning/benchmark/raw_mamba_smarthealth_eve280.json"
    ;;
  *)
